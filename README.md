...
ส่วน `หุ้นที่เล็งไว้` แก้ไขได้จากหน้า Main โดยพิมพ์ค้นหา ticker ใน dropdown แล้วเลือกได้หลายตัว จากนั้นกด `บันทึกรายการที่เล็งไว้` รายการจะถูกเก็บไว้ใน `data/watchlist.json` และถูกสแกนแยกจากหุ้นนางฟ้า 7 อันดับ
